...
model.load_state_dict(torch.load('v2/enet_best.pth', map_location=device))
model.eval()
...
def generate_guidance(pred):
    # Gộp lớp 7 (Barrie) thành lớp 6 (Rào chắn) trong bản đồ phân đoạn
    ...
    elif bottom_prop[2] > 0.2 or bottom_prop[3] > 0.2:  
...
# Demo với ảnh
image_path = 'v2/demo/test1.jpg'
output_path = 'v2/demo/test1'
